! function(n) {
    ...
    n("#side-menu").metisMenu(), n("#vertical-menu-btn").on("click", function(e) {
        ...
        }), document.addEventListener("fullscreenchange", s), document.addEventListener("webkitfullscreenchange", s), document.addEventListener("mozfullscreenchange", s), n(".right-bar-toggle").on("click", function(e) {
        ...
        function() {
            ...
            t(e.target.id)
        }), e(), n("#checkAll").on("change", function() {
