    ...
    <div class="container">
        <div class="">
            ...
            <div class='uk-text-container'>
                ...
                <p class='text-title'>一、隱私權保護政策的適用範圍</p>
                <p>隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</p>
                <p class='text-title'>二、個人資料的蒐集、處理及利用方式</p>
                <ul>
                ...
                <p class='text-title'>四、網站對外的相關連結</p>
                <p>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</p>
                <p class='text-title'>五、與第三人共用個人資料之政策</p>
                ...
                <p class='text-title'>六、Cookie之使用</p>
                <p>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導致網站某些功能無法正常執行。</p>
                <p class='text-title'>七、隱私權保護政策之修正</p>
                <p>本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。</p>
            </div>
            <div class="uk-text-container en">
                <p>
                    Last updated: February 14, 2023<br />
                ...
                <p class='text-title'>Interpretation and Definitions</p>
                <p class='text-subtitle'>Interpretation</p>
                <p>
                    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </p>
                <p class='text-title'>Definitions</p>
                <p>For the purposes of this Privacy Policy:</p>
                <ul>
                    <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                    <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to all-well, No. 75, Liuchiao West Rd., Chingkou Village, Puhsin Hsiang, Changhua, Taiwan, R.O.C. 51346.</li>
                    ...
                    <li><strong>Website</strong> refers to all-well, accessible from <a href="http://www.all-well.com.tw/">http://www.all-well.com.tw/</a></li>
                    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
                <p class='text-title'>Collecting and Using Your Personal Data</p>
                <p class='text-title'>Types of Data Collected</p>
                <p class='text-subtitle'>Personal Data</p>
                ...
                <p class='text-subtitle'>Usage Data</p>
                <p>
                ...
                <p class='text-subtitle'>Tracking Technologies and Cookies</p>
                ...
                <p class='text-title'>Use of Your Personal Data</p>
                <p>
                ...
                <p class='text-title'>Retention of Your Personal Data</p>
                <p>
                ...
                <p class='text-title'>Transfer of Your Personal Data</p>
                <p>
                ...
                <p class='text-title'>Delete Your Personal Data</p>
                <p>
                ...
                <p class='text-title'>Disclosure of Your Personal Data</p>
                <p class='text-subtitle'>Business Transactions</p>
                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                <p class='text-subtitle'>Law enforcement</p>
                <p>
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </p>
                <p class='text-subtitle'>Other legal requirements</p>
                ...
                <p class='text-title'>Security of Your Personal Data</p>
                <p>
                    The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
                </p>
                <p class='text-title'>Children's Privacy</p>
                <p>
                ...
                <p class='text-title'>Links to Other Websites</p>
                <p>
                ...
                <p class='text-title'>Changes to this Privacy Policy</p>
                <p>
                ...
                <ul>
                    <li>By email: <a href="mailto:sales@all-well.com.tw">sales@all-well.com.tw</a></li>
                    <li>By visiting this page on our website: <a href="http://www.all-well.com.tw/contact">http://www.all-well.com.tw/contact</a></li>
                </ul>
            </div>
        </div>
    </div>
