            ...
            <div class="col-md-3 col-sm-12 col-padding">
                <aside class="sideContnet">
                    <ul>
                        <li class="sideInner active">
                            <div class="sideActive">
                                <div class="sideActiveInner">
                                    <span class='uk-text-subtitle'>{產品分類第二層}</span>
                                </div>
                                <div class="sideActiveInner">
                            ...
                            <ul class="sideInnerMenu">
                                <li class="sideInner"><a href="productList.php">{產品分類第三層}</a></li>
                                <li class="sideInner"><a href="productList.php">{產品分類第三層}</a></li>
                                <li class="sideInner"><a href="productList.php">{產品分類第三層}</a></li>
                                <li class="sideInner"><a href="productList.php">{產品分類第三層}</a></li>
                            </ul>
                        ...
                        <li class="sideInner">
                            <a href="productCate.php" class="uk-text-subtitle">{產品分類第二層}</a>
                        </li>
                        <li class="sideInner">
                            <a href="productCate.php" class="uk-text-subtitle">{產品分類第二層}</a>
                        </li>
                            ...
                            <div class="uk-card-liner">
                                <div class="uk-card-item">
                                    <div class="uk-card-header">
                                        <a href="productList.php" class='img-content img-4by3'><img src="images/sampleCategory/nike.jpg" /></a>
                                    </div>
                                    <div class="uk-card-body">
                                        <a href="productList.php" class="text-title">{產品分類第三層}</a><br />
                                        <a href="productList.php" class="uk-text-subtitle">{產品分類副標題}</a>
                                    </div>
                                    <div class="uk-card-footer">
                                        <a href="productList.php" class='ell-text'>{Our mission is what drives us to do everything possible to expand human potential. We do that by creating groundbreaking sport innovations, by making our products more sustainably, by building a creative and diverse global team and by making a positive impact in communities where we live and work. Based in Beaverton, Oregon, NIKE, Inc. includes the Nike, Converse, and Jordan brands.}</a>
                                    </div>
                                </div>
                            </div>
                            <!-- item-main_end -->
