            ...
            <div class="col-md-9 col-padding">
                ...
                <ul class="newsItemContent">
                    ...
                    <li class="newsItem">
                        ...
                        <div class="newsItemInner">
                            <a href="pageCateB.php" class="text-title">{分類文章列表標題(一)}</a>
                            <time class="">{2021 - 0227}</time>
                            <a href="pageCateB.php">{台灣往年遇到的颱風大多是從西北太平洋來的，根據氣象局2010年至2019年氣候年報顯示，西北太平洋海域全年颱風生成數最多的一年為2013年，當年有31個颱風生成；最少為2010年，有14個颱風生成。從生成月份來看，颱風主要生成季節於7月至10月，以2019年舉例，全年颱風總數為29個，8月、9月至11月生成數較多。}</a>
                        </div>
                    </li>
                    <!-- page_item_end -->
                    <!-- page_item_start -->
