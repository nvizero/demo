                                ...
                                <div class="uk-card-liner">
                                    <div class="uk-card-item">
                                        <div class="uk-card-header">
                                            <a href="/posts_categories/{{$cate->id}}" class='img-content img-4by3'><img src="/storage/{!! $cate->img !!}" /></a>
                                        </div>
                                        <div class="uk-card-body">
                                            <a href="/posts_categories/{{$cate->id}}" class="text-title">{!! $cate->title !!}</a><br />
                                            <a href="/posts_categories/{{$cate->id}}" class="uk-text-subtitle">{!! $cate->subtitle !!}</a>
                                        </div>
                                        <div class="uk-card-footer">
                                            <a href="/posts_categories/{{$cate->id}}" class='ell-text'>{!! ms_str($cate->content ,20)!!}</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- item-main_end -->
