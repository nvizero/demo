                                ...
                                <div class="uk-card-liner">
                                    <div class="uk-card-item">
                                        <div class="uk-card-header">
                                          <a href="/post/{{$pro->id}}/{{$cate->parent_id}}" class='img-content img-4by3'>
                                            <img src="/storage/{{$pro->img}}" />
                                          </a>
                                        </div>
                                        <div class="uk-card-body">
                                            <a href="/post/{{$pro->id}}/{{$cate->parent_id}}" class="text-title">{{$pro->title}}</a><br />
                                            <a href="/post/{{$pro->id}}/{{$cate->parent_id}}" class="uk-text-subtitle">{{$pro->subtitle}}</a>
                                        </div>
                                        <div class="uk-card-footer">
                                            <a href="/post/{{$pro->id}}/{{$cate->parent_id}}" class='ell-text'>{!! ms_str($pro->content ,20)!!}</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- item-main_end -->
                        ...
                        @else
                          ...
                          <div class="col-md-4 col-sm-6 col-xs-12 col-padding">
                              ...
                              <div class="uk-card-liner">
                                  <div class="uk-card-item">
                                      <div class="uk-card-header">
                                          <a href="/posts_categories/{{$pcate->id}}" class='img-content img-4by3'><img src="/storage/{{$pcate->img}}" /></a>
                                      </div>
                                      <div class="uk-card-body">
                                          <a href="/posts_categories/{{$pcate->id}}" class="text-title">{{$pcate->title}}</a><br />
                                          <a href="/posts_categories/{{$pcate->id}}" class="uk-text-subtitle">{{$pcate->subtitle}}</a>
                                      </div>
                                      <div class="uk-card-footer">
                                          <a href="/posts_categories/{{$pcate->id}}" class='ell-text'>{!! ms_str($pcate->content ,20)!!}</a>
                                      </div>
                                  </div>
                              </div>
                              <!-- item-main_end -->
